...
template <typename ITEM> int AVLNode<ITEM>::getHeight() {

    return height;
}

template <typename ITEM> AVLNode<ITEM>* AVLNode<ITEM>::getLeft() {
    if (this == NULL) {
        return NULL;
    }
    return (AVLNode<ITEM> *) this->left;
}
template <typename ITEM> AVLNode<ITEM>* AVLNode<ITEM>::getRight() {
    if (this == NULL) {
        return NULL;
    }
    return (AVLNode<ITEM> *) this->right;
}
template <typename ITEM> AVLNode<ITEM>* AVLNode<ITEM>::getParent() {
    if (this == NULL) {
        return NULL;
    }
    return (AVLNode<ITEM> *) this->parent;
}
